...
Every requirement listed must be traceable to a source. Flag gaps clearly — the `report-writer` needs them to produce the "Missing Requirement Coverage" section.
