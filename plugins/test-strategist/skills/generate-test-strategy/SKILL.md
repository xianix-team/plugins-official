...
description: Trigger a full test strategy generation. Gathers requirements, code changes, and risk assessment to produce a business-readable HTML test guide. Usage: /generate-test-strategy [issue-number or work-item-id]
...
6. Launch the **test-guide-writer** to produce the final HTML test guide
7. Write the report to `test-strategy-report.html` and post a summary
